...
class Decline extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('Ziffity_Feedback::feedback');
    }
    ...
    public function execute()
    {
        ...
        if (isset($id)) {
            ...
            if ($mailStatus) {
                ...
                $this->messageManager->addError(__('Something went wrong! We couldn\'t sent feedback approval status to customer by email.'));
            }
